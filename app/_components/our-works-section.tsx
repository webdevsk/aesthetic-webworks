  ...
  return (
    <section>
      <div
        ...
        className="relative h-[calc((var(--element-width)_-_var(--container-width)))]">
        <div className="sticky left-0 top-0 h-dvh">
          <div className="overflow-clip">
            <motion.div
              ref={scrollingElement}
              style={{ ["--progress" as string]: scrollYProgress }}
              className="w-[calc(var(--element-width)_-_var(--container-width))] translate-x-[calc(var(--progress)_*_100%_*_-1)] overflow-visible">
              <div className="h-12 w-[4000px] border-2 border-red-700 bg-gradient-to-r from-primary to-secondary "></div>
            </motion.div>
          </div>
        </div>
      </div>
